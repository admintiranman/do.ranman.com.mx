    ...
    <section class="section">        
        <div class="columns is-mobile is-centered">            
            <div class="column is-three-quarters">
                ...
                <hr>
                <form method="post" action="{{ route('survey.summary.update', [$survey, $summary]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="field">
                        ...
                        <div class="control @error('text') has-icons-right @enderror">
                            <input value="{{ $summary->text }}" type="text" name="text"
                    ...
                    <p>
                        <v-summary-options :opts="{{$summary->options}}"></v-summary-options>
                    </p>
