...
<head>
    ...
    <script type="text/javascript">
        ...
        ?>
            Tid = `<?php echo $val['id']; ?>`;
            Treporta = `<?php echo $val['reporta']; ?>`;
            Tnombre = `<?php echo $val['nombre']; ?>`;
            Tcorreo = `<?php echo $val['correo']; ?>`;
            Tpuesto = `<?php echo $val['puesto']; ?>`;
            Tnivel = `<?php echo $val['nivel']; ?>`;
    ...
    <script type="text/javascript">
        ...
        function getContactTemplate(minimizedItemCornerRadius, minimizedItemSize, highlightPadding) {
            ...
            var itemTemplate = jQuery(
                ...
                '<div name="description" class="bp-item" style="top: 672px; left: 56px; width: 162px; height: 36px; font-size: 10px;"></div>' +
                '</div>'
            ).css({
        ...
        function onTemplateRender(event, data) {
            ...
            if (data.templateName == "contactTemplate") {
                ...
                data.element.find("[name=email]").attr({
                    "href": ("mailto:" + itemConfig.email + "?Subject=Hello%20world")
                });
