...
class soporte_survey_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $survey = Survey::create([
            'name' => 'EVALUACIÓN DE DESEMPEÑO Y POTENCIA (Soporte Administrativo)',
            'description' => 'Evaluación de desempeño y potencia.',
            'level_id' => Level::where("name", "Soporte Administrativo")->first()->id
        ]);
        ...
        Question::create(['subsummary_id' => $sub->id, 'text' => 'Propone nuevas ideas  para mejorar el área']);        
